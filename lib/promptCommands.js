...
function firstCommands(terminal, command) {
    if (command.match("^whoami$")) {
        ...
        terminal.echo("[" + green_text + "ϟ] Twitter, href=\""+ links[1] +"\"");
        terminal.echo("[" + green_text + "ϟ] Facebook, href=\"" + links[2] + "\"");
        terminal.echo("[" + green_text + "ϟ] Instagram, href=\"" + links[3] + "\"");
        terminal.echo("[" + green_text + "ϟ] GooglePlus, href=\"" + links[5] + "\"");
        terminal.echo("[" + green_text + "ϟ] LinkedIn, href=\"" + links[6] + "\"");
        terminal.echo("[" + green_text + "ϟ] Blogger, href=\"" + links[9] + "\"");
        terminal.echo("[" + green_text + "ϟ] YouTube, href=\"" + links[10] + "\"");

    } else if (command.match("^events$")) {
        terminal.echo("[" + green_text + "☑] Pixels Camp 2017");
        ...
        terminal.echo(">available [" + white_text + "commands] (for now...) {" +
            "\n [" + white_text + "< whoami >]" +
            "\n [" + white_text + "< education >] path" +
            "\n [" + white_text + "< career >] path" +
            "\n [" + white_text + "< social >] networks" +
            "\n [" + white_text + "< events >] he went" +
            "\n [" + white_text + "< contact >]" +
            "\n --- \\ --" +
            "\n [" + white_text + "< open > < what? >]" +
            // "\n [" + white_text + "< send >] mail" +
            "\n [" + white_text + "< help > or < help > < what? >]" +
            "\n [" + white_text + "< clear >] clear the prompt" +
            "\n [" + white_text + "< history >] of commands" +
            "\n [" + white_text + "< version >]" +
            "\n}");
        ...
        terminal.echo("$ currently in version v1.0... :P \n" +
                      "$ This page built with jQuery Terminal Emulator plugin, and hosted by GitHub Pages.\n" +
