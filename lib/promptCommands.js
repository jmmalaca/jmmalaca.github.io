...
function firstCommands(terminal, command) {
    if (command.match("^whoami$")) {
        ...
        terminal.echo("$ [" + white_text + "I'm a Software/Ruby on Rails Engineer trying to follow the cake driven development, always learning, growing, enjoying life and working hard so one day I can be a good team/tech leader.]");
        terminal.echo("$");
        ...
        terminal.echo("$ Software Engineer @ [" + white_text + "The Loop Company], Coimbra, Portugal, 2019/...");
        terminal.echo("$ Software Engineer @ [" + white_text + "Laboratory for Informatics and Systems of Instituto Pedro Nunes], Coimbra, Portugal, 2017/2019");
