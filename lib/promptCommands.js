...
function firstCommands(terminal, command) {
    if (command.match("^whoami$")) {
        ...
        terminal.echo("$ Web/Ruby on Rails Engineer @ [" + white_text + "Laboratory for Informatics and Systems of Instituto Pedro Nunes], Coimbra, Portugal, 2017/2019");
        ...
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "InvoiceXpress], href=\"" + projectsLinks[0] + "\"");
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "SkiSolutions], href=\"" + projectsLinks[1] + "\"");
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "Hotelcracy], href=\"" + projectsLinks[2] + "\"");
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "CascaisGo], href=\"" + projectsLinks[3] + "\"");
        terminal.echo("[" + green_text + "ϟ] [" + green_text + "SaudeMental], href=\"" + projectsLinks[4] + "\"");
